...
<body>
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="img/books.jpg">
        <form class="d-flex tm-search-form" action="{{ route('home.search') }}" method="GET">
            <input class="form-control tm-search-input" type="search" placeholder="Search" aria-label="Search" value="{{ old('search', request()->search) }}">
